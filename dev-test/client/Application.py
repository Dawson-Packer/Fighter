...
from client.ProgramLogic import *
    ...
    def process_events(self):
        ...
        for event in pygame.event.get():
            ...
            if mouse_buttons_state[0]:
                if self.pl.scene == 0:
                    for button in self.pl.main_menu.button_list:
                        button.check_button(pygame.mouse.get_pos())
                if self.pl.scene == 1:
                    for button in self.pl.lobby.button_list:
                        button.check_button(pygame.mouse.get_pos())
